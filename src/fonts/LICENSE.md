...
`src/styles.css` las declaran primero: si algún día se compran las licencias, basta con dejar los
`.woff2` en esta carpeta y añadir sus `@font-face` para que la app las use sin tocar nada más.

El build copia estos archivos desde `src/fonts/` al sitio estático.
